...
<?php // echo '<pre>'; print_r($course); echo '</pre>'; 
    ...
    $registered     =   ($course)? $course->registered_at : '';
...
<div class="page-header mt-0 shadow p-3">
    <ol class="breadcrumb mb-sm-0">
        ...
        <li class="breadcrumb-item"><a href="{{url('admin/registered/courses')}}">Registered Courses</a></li>
            ...
            <div class="card-body">
                ...
                <div id="dtl-content" class="tab-content">
                    <div class="tab-pane active" id="course-tab-content"><br /><br /> 
                        @include('admin.pages.registered_courses.details.general')
                    </div><?php 
                     if($id > 0){ ?>
                        <div class="tab-pane" id="media-tab-content"><br />
                            @include('admin.pages.registered_courses.details.media')
                        </div>
                        <div class="tab-pane" id="ms-tab-content"><br />
                            @include('admin.pages.registered_courses.details.milestones')
                        </div><?php
                     } ?>
                </div>
                <hr />
                <div class="col-md-12 ">
                    <div class="d-flex flex-row-reverse">
                        ...
                        <a href="{{url('admin/registered/courses')}}" class="p-2">{{ Form::button('Cancel', array('class' => 'btn btn-edit pull-right cancel_btn', 'type' => 'button')) }} </a>
                    </div>
                </div>
