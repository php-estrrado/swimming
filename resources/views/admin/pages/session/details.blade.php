...
<div class="page-header mt-0 shadow p-3">
    <ol class="breadcrumb mb-sm-0">
        ...
        <li class="breadcrumb-item"><a href="{{url('admin/activity/session/requests')}}">Session Requests</a></li>
...
<div class="row">
    <div class="col-xl-12">
        <div class="card shadow">
            ...
            <div class="card-body">
                {{ Form::open(array('url' => "admin/activity/session/save", 'id' => 'sessionForm', 'name' => 'sessionForm', 'class' => '','files'=>'true')) }}
                    {{Form::hidden('rId', $id)}}
                    <div class="tab-content">
                        <div class="tab-pane active" id="course-tab-content"><br /><br /> 
                            @include('admin.pages.session.details.general')
                        </div>
                    ...
                    <div class="col-md-12 ">
                        <div class="d-flex flex-row-reverse">
                            ...
                            <div class="p-2"><a href="{{url('/admin/activity/session/requests')}}">{{ Form::button('Cancel', array('class' => 'btn btn-edit pull-right cancel_btn', 'type' => 'button')) }} </a></div>
                        </div>
                    </div>
                {{ Form::close() }}  
            </div>
