                ...
                foreach ($activities as $row) {
                    ...
                    <tr class="dtrow" id="dtrow-{{$row->id}}">
                        ...
                        <td class="text-center">
                            <a href="{{url('/admin/activity/session/request/'.$row->id)}}" id="e-{{$row->id}}" data-value="Edit" class="btn btn-sm btn-primary btn-edit"><i class="fa fa-edit"></i> Edit</a>
...
<script src="{{asset('public/bizzadmin/assets/js/datatable/session_request-datatable.js')}}"></script>
