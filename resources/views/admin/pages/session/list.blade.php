    ...
    <div class="col-xl-12">
        <div class="card shadow">
            ...
            <div id="course_list" class="card-body table-card-body">
                @include('admin.pages.session.list.content')
            </div>
...
$(document).ready(function () {
    ...
    $("body").on("click", ".approveBtn", function () {
        ...
        var url     =   '{{url("/admin/session/update/status")}}';
        var smsg    =   'Request approved successfully!';
        updateStatus(id,cId,sts,url,'dtrow-','status',smsg,'request_extra_activity_session','act_status');
    });
