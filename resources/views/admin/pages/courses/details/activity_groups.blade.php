    ...
    @foreach($groups as $k=>$group)  
        ...
        <div class="act-group">
            <div id="group-{{$group->id}}" class="gr-container">
                <div id="gr-title-{{$group->id}}" data-toggle="off" class="gr-title">
                    <div class="col-12 col-md-9 fl" style="cursor: pointer;" onclick="openGrTab('gr-title-{{$group->id}}')">{{$group->group_name}}</div>
