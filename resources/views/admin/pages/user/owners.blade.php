...
<div class="page-header mt-0 shadow p-3">
    <ol class="breadcrumb mb-sm-0">
        ...
        <li class="breadcrumb-item active" aria-current="page">Salon Owners</li>
    </ol>
</div>
<div class="row">
    <div class="col-xl-12">
        <div class="card shadow">
            ...
            <div class="card-body table-card-body">
                <div>
                    <table id="ownerslist" class="owner-table table table-striped table-bordered w-100 text-nowrap">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            if ($users) {
                                ...
                                foreach ($users as $user) {
                                    ...
                                    $membership = ($user->mname) ? $user->mname : $na;
                ...
                <button id="send-msg-btn" type="button" class="btn btn-sm btn-primary mt-1 mb-1"><i class="fa fa-paper-plane"></i> Send System Generated Message</button>
...
<script src="{{asset('public/bizzadmin/assets/js/datatable/owner-datatable.js')}}"></script>
<script>
