...
@section('title', 'Active Salon Owners')
@section('content')
...
<div class="page-header mt-0 shadow p-3">
    <ol class="breadcrumb mb-sm-0">
        ...
        <li class="breadcrumb-item active" aria-current="page">Active Salon Owners</li>
    </ol>
</div>
<div class="row">
    <div class="col-xl-12">
        <div class="card shadow">
            <div class="card-header">
                <h2 class="mb-2">Active Salon Owners</h2>
            ...
            <div class="card-body table-card-body">
                <div>
                    <table id="activeownerslist" class="activeowner-table table table-striped table-bordered w-100 text-nowrap">
                        <thead>
                            <tr>
...
<script src="{{asset('public/bizzadmin/assets/js/datatable/activeowner-datatable.js')}}"></script>
<script>
