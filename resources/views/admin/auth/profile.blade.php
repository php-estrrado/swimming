    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form id="profileform" name="profileform" method="POST" action="{{url('admin/profile/update')}}">
                        <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        {{ Form::text('role', $profile->role_name, ['class' => 'form-control','id'=>'role','disabled'=>true]) }}
