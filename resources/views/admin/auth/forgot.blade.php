            ...
            <div class="container-login100">
                <div class="wrap-login100 p-5">
                    <div style="width:100%">
                        ...
                        <form id="resetpasswordform" name="resetpasswordform" method="POST" class="login100-form validate-form" action="{{url('admin/sendresetlink')}}">
                            <span class="login100-form-title">
                                Reset Password
                            </span>
                            <div class="wrap-input100 validate-input">
                                <input class="input100" type="text" name="email" id="email" placeholder="E-Mail Address">
                            ...
                            <div class="container-login100-form-btn">
                                ...
                                <button type="submit" class="login100-form-btn btn-primary">Send Password Reset Link</button>
                            </div>
                            {{ csrf_field() }}
                        </form>
                    </div>
