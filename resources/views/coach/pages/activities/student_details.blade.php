...
<div class="page-header mt-0 shadow p-3">
    <ol class="breadcrumb mb-sm-0">
        ...
        <li class="breadcrumb-item"><a href="{{url('coach/cours/'.$activity->reg_course_id)}}">{{$activity->course_name}}</a></li>
        <li class="breadcrumb-item"><a href="{{url('coach/course/'.$activity->reg_course_id.'/'.$activity->student_id)}}">Student Activities</a></li>
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-12 ">
                        <div class="d-flex flex-row-reverse row">
                            ...
                            <div class="p-2"><a href="{{url('/coach/course/'.$activity->reg_course_id.'/'.$activity->student_id)}}">{{ Form::button('Back', array('class' => 'btn btn-edit pull-right cancel_btn', 'type' => 'button')) }} </a></div>
                        </div>
                    </div>
            </div>
        </div>
