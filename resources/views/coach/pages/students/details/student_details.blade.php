...
@section('title', 'Student Activity Details')
@section('content')
...
<div class="page-header mt-0 shadow p-3">
    <ol class="breadcrumb mb-sm-0">
        ...
        <li class="breadcrumb-item"><a href="{{url('coach/student/'.$activity->student_id)}}">{{$activity->name}}</a></li>
        <li class="breadcrumb-item"><a href="{{url('coach/student/'.$activity->reg_course_id.'/'.$activity->student_id)}}">Student Activities</a></li>
            ...
            <div class="card-body">
                    <div class="">
                        <ul class="nav nav-tabs">
                           <li id="general-tab" class="active"><a data-toggle="tab" href="#general">Activity</a></li>&nbsp;
                           <li id="media-tab"><a data-toggle="tab" href="#media">Media</a></li>
                       </ul>
                    </div>
                    <div class="tab-content"> <?php // echo '<pre>'; print_r($activity); echo '</pre>'; ?>
                    ...
                    <div class="col-md-12 ">
                        <div class="d-flex flex-row-reverse row">
                            ...
                            <div class="p-2"><a href="{{url('/coach/student/'.$activity->reg_course_id.'/'.$activity->student_id)}}">{{ Form::button('Back', array('class' => 'btn btn-edit pull-right cancel_btn', 'type' => 'button')) }} </a></div>
                        </div>
                    </div>
            </div>
        </div>
