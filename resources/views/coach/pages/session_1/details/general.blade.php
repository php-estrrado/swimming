    ...
    <div class="staff-general">
        <div class="row">
            ...
            <div class="col-md-12 mb-2">
                ...
                {{ Form::textarea('gen[description]', $description, ['id'=>'description','class' => 'form-control','rows'=>3,'readonly'=>true]) }}
            ...
            <div class="col-md-6 mb-2mb-2">
                ...
                {{ Form::text('gen[submited_at]', date('Y-m-d',strtotime($submited)), ['id'=>'submited_at','class' => 'form-control','disabled'=>true]) }}
            </div>
            <div class="col-md-6 mb-2">
                <div class="row">
                    {{ Form::label('act_status', 'Status', ['class' => 'control-label']) }}
                    {{ Form::select('gen[act_status]',['Pending'=>'Pending','Approved'=>'Approved','Rejected'=>'Rejected'], $status, ['id'=>'act_status','class' => 'form-control','disabled'=>true]) }}
                </div>
            </div>
