{{ Form::open(array('url' => "coach/course/save", 'id' => 'courseForm', 'name' => 'courseForm', 'class' => '','files'=>'true')) }}
    {{Form::hidden('cId', $id)}}
    <div class="form-group">
        <div class="course-general">
            <div class="row">
               ...
               <div class="col-md-4 mb-2">
                    {{ Form::label('Coach', 'Coach', ['class' => 'control-label label-name']) }}
                    <div class="label-val">{{$coach}}</div>
                </div>
                <div class="col-md-4 mb-2">
                ...
                <div class="col-md-4 mb-2">
                    {{ Form::label('Start Date', 'Start Date', ['class' => 'control-label label-name']) }}
                    <div class="label-val">{{$startDate}}</div>
                </div>
                <div class="col-md-4 mb-2">
                    {{ Form::label('End Date', 'End Date', ['class' => 'control-label label-name']) }}
                    <div class="label-val">{{$endDate}}</div>
                </div>
                <div class="col-md-4 mb-2">
