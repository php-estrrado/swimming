                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {{Form::text('activity_name', '', ['id'=>'activity_name','class' => 'form-control','disabled'=>true])}}
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {{Form::textarea('activity_desc', '', ['id'=>'activity_desc','class' => 'form-control','rows'=>12,'maxlength'=>750,'disabled'=>true])}}
            ...
            <div class="modal-footer">
                <div class="col-md-12 ">
                    <div class="fr">
                        ...
                        <button id="act-close-btn" type="button" class="btn btn-edit mt-1">Close</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                        {{ Form::label('active', 'Status', ['class' => 'control-label required']) }}
                        {{Form::select('group[active]',[1=>'Active',0=>'Inactive'],'',['class'=>'form-control required chosen-select'])}}
                    </div>
                    <div class="col-md-12 ">
                    </div>
                </div>
    ...
    function insertActivityMedia(table,fId,actId,file,type,path){
        ...
        xhttp.onreadystatechange = function() {
          if (this.readyState == 4 && this.status == 200) { 
                ...
                var content     =   content+$('#additional_act_media').html();
