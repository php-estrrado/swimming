                                                ...
                                                <div id="act-{{$row->id}}" class="act odd">
                                                    ...
                                                    <div class="col-2 col-md-1 fl"><div class="row">
                                                        @php if((int)$row->id > 0){ @endphp 
                                                            <a href="{{url('coach/course/'.$row->reg_course_id.'/'.$row->student_id.'/'.$row->id)}}" class="fl link abs">
...
<div class="col-md-12 ">
    <div class="d-flex flex-row-reverse row">
        <div class="p-2"><a href="{{url('/coach/course/'.$id)}}">{{ Form::button('Back', array('class' => 'btn btn-edit pull-right cancel_btn', 'type' => 'button')) }} </a></div>
    </div>
</div>
